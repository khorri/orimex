...
@Service
@Transactional
public class AchatArticleConteneurArrivageServiceImpl implements AchatArticleConteneurArrivageService {

    private final Logger log = LoggerFactory.getLogger(AchatArticleConteneurArrivageServiceImpl.class);
    ...
    public AchatArticleConteneurArrivageServiceImpl(AchatArticleConteneurArrivageRepository achatArticleConteneurArrivageRepository, AchatArticleConteneurArrivageMapper achatArticleConteneurArrivageMapper, AchatArticleConteneurArrivageSearchRepository achatArticleConteneurArrivageSearchRepository) {
