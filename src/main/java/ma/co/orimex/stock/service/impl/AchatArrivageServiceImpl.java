...
@Service
@Transactional
public class AchatArrivageServiceImpl implements AchatArrivageService {

    private final Logger log = LoggerFactory.getLogger(AchatArrivageServiceImpl.class);
    ...
    public AchatArrivageServiceImpl(AchatArrivageRepository achatArrivageRepository, AchatArrivageMapper achatArrivageMapper, AchatArrivageSearchRepository achatArrivageSearchRepository) {
