...
export class JourFerierComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.jourFerierService
                ...
                .subscribe(
                    (res: HttpResponse<IJourFerier[]>) => this.paginateJourFeriers(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInJourFeriers();
    }
    ...
    registerChangeInJourFeriers() {
        this.eventSubscriber = this.eventManager.subscribe('jourFerierListModification', response => this.loadAll());
    }
    ...
    private paginateJourFeriers(data: IJourFerier[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.jourFeriers = data;
    }
