...
export class RetourComponent implements OnInit, OnDestroy {
    currentAccount: any;
    retours: IRetour[];
    error: any;
    success: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.retourService
                ...
                .subscribe(
                    (res: HttpResponse<IRetour[]>) => this.paginateRetours(res.body, res.headers),
    ...
    trackId(index: number, item: IRetour) {
        return item.id;
    }
    ...
    private paginateRetours(data: IRetour[], headers: HttpHeaders) {
