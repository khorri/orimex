...
export class ReceptionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.receptionService
                ...
                .subscribe(
                    (res: HttpResponse<IReception[]>) => this.paginateReceptions(res.body, res.headers),
    ...
    registerChangeInReceptions() {
        this.eventSubscriber = this.eventManager.subscribe('receptionListModification', response => this.loadAll());
    }
    ...
    private paginateReceptions(data: IReception[], headers: HttpHeaders) {
