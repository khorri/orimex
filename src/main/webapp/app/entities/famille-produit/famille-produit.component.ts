...
export class FamilleProduitComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.familleProduitService
                ...
                .subscribe(
                    (res: HttpResponse<IFamilleProduit[]>) => this.paginateFamilleProduits(res.body, res.headers),
    ...
    trackId(index: number, item: IFamilleProduit) {
        return item.id;
    }

    registerChangeInFamilleProduits() {
        this.eventSubscriber = this.eventManager.subscribe('familleProduitListModification', response => this.loadAll());
    }
    ...
    private paginateFamilleProduits(data: IFamilleProduit[], headers: HttpHeaders) {
