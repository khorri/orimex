...
export class CouleurComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.couleurService
                ...
                .subscribe(
                    (res: HttpResponse<ICouleur[]>) => this.paginateCouleurs(res.body, res.headers),
    ...
    private paginateCouleurs(data: ICouleur[], headers: HttpHeaders) {
