...
export class TransfertComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.transfertService
                ...
                .subscribe(
                    (res: HttpResponse<ITransfert[]>) => this.paginateTransferts(res.body, res.headers),
    ...
    trackId(index: number, item: ITransfert) {
        return item.id;
    }
    ...
    private paginateTransferts(data: ITransfert[], headers: HttpHeaders) {
