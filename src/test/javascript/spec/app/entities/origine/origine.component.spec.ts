...
import { OrigineComponent } from 'app/entities/origine/origine.component';
import { OrigineService } from 'app/entities/origine/origine.service';
import { Origine } from 'app/shared/model/origine.model';

describe('Component Tests', () => {
    describe('Origine Management Component', () => {
        let comp: OrigineComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OrigineComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.origines[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
