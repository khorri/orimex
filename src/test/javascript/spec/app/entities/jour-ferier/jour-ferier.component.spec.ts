...
import { JourFerierComponent } from 'app/entities/jour-ferier/jour-ferier.component';
...
describe('Component Tests', () => {
    describe('JourFerier Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.jourFeriers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
