...
import { ReceptionComponent } from 'app/entities/reception/reception.component';
...
describe('Component Tests', () => {
    describe('Reception Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.receptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
