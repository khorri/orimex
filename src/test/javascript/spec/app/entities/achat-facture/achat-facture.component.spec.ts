...
import { AchatFactureComponent } from 'app/entities/achat-facture/achat-facture.component';
...
describe('Component Tests', () => {
    describe('AchatFacture Management Component', () => {
        let comp: AchatFactureComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [AchatFactureComponent],
                providers: [
                    {
                ...
                .overrideTemplate(AchatFactureComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.achatFactures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
