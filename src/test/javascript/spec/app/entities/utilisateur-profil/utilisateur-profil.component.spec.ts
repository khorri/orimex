...
import { UtilisateurProfilComponent } from 'app/entities/utilisateur-profil/utilisateur-profil.component';
...
describe('Component Tests', () => {
    describe('UtilisateurProfil Management Component', () => {
        let comp: UtilisateurProfilComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UtilisateurProfilComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new UtilisateurProfil(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.utilisateurProfils[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
