...
import { IAchatArticleConteneurArrivage, AchatArticleConteneurArrivage } from 'app/shared/model/achat-article-conteneur-arrivage.model';

describe('Service Tests', () => {
    describe('AchatArticleConteneurArrivage Service', () => {
        let injector: TestBed;
        let service: AchatArticleConteneurArrivageService;
        let httpMock: HttpTestingController;
        let elemDefault: IAchatArticleConteneurArrivage;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a AchatArticleConteneurArrivage', async () => {
                ...
                service
                    .create(new AchatArticleConteneurArrivage(null))
                    .pipe(take(1))
            ...
            it('should delete a AchatArticleConteneurArrivage', async () => {
