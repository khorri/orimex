...
describe('Service Tests', () => {
    describe('Utilisateur Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Utilisateur(0, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Utilisateur', async () => {
                const returnedFromService = Object.assign(
                    {
                        idUtilisateur: 1,
                        loginUtilisateur: 'BBBBBB',
                        matriculeUtilisateur: 'BBBBBB',
                        nomUtilsateur: 'BBBBBB',
                        passwordUtilisateur: 'BBBBBB',
                        prenomUtilsateur: 'BBBBBB'
                    },
                    elemDefault
                );
