...
import { CouleurComponent } from 'app/entities/couleur/couleur.component';
import { CouleurService } from 'app/entities/couleur/couleur.service';
import { Couleur } from 'app/shared/model/couleur.model';

describe('Component Tests', () => {
    describe('Couleur Management Component', () => {
        let comp: CouleurComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CouleurComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.couleurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
