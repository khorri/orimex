...
import { AchatFournisseurComponent } from 'app/entities/achat-fournisseur/achat-fournisseur.component';
...
describe('Component Tests', () => {
    describe('AchatFournisseur Management Component', () => {
        let comp: AchatFournisseurComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AchatFournisseurComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.achatFournisseurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
