...
import { RecuperationComponent } from 'app/entities/recuperation/recuperation.component';
...
describe('Component Tests', () => {
    describe('Recuperation Management Component', () => {
        let comp: RecuperationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RecuperationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.recuperations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
