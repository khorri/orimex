...
import { ConteneurComponent } from 'app/entities/conteneur/conteneur.component';
...
describe('Component Tests', () => {
    describe('Conteneur Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.conteneurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
