...
import { TypeBonComponent } from 'app/entities/type-bon/type-bon.component';
import { TypeBonService } from 'app/entities/type-bon/type-bon.service';
import { TypeBon } from 'app/shared/model/type-bon.model';

describe('Component Tests', () => {
    describe('TypeBon Management Component', () => {
        let comp: TypeBonComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypeBonComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typeBons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
