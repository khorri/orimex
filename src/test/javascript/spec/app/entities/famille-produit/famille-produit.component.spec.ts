...
import { FamilleProduitComponent } from 'app/entities/famille-produit/famille-produit.component';
...
describe('Component Tests', () => {
    describe('FamilleProduit Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.familleProduits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
